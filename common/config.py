...
BASE_URL: str = os.getenv("BASE_URL", "https://example.com").strip()  # Corrigido espaços
...
# Não coloque variáveis fixas aqui se já estão no .env
# As linhas abaixo NÃO devem existir:
# BASE_URL=https://exemplo.com  
# HEADLESS=false
# USER_EMAIL=seu@email.com
# USER_PASSWORD=super-secreto